      ...
      <br />
	    ...
	    <div className= 'row'>
              ...
              <p>
                 <ul>
                     ...
                     and make sure it is running in WSL 2 mode. You can check this by opening PowerShell and entering: <code style='background-color:7a918d;'>wsl -l -v</code> </li>
        ...
        <p>
          ...
          <ol>
            ...
            <li>
              Create a new project folder: mkdir ReactProjects and enter that directory: <code style='background-color:7a918d'>cd ReactProjects.</code>
            </li>
            <li>
              Install React using create-react-app, a tool that installs all of the dependencies to build and run a full React.js application: <code style='background-color:7a918d'>npx create-react-app my-app</code> 
            </li>
            <li>
              This will first ask for your permission to temporarily install create-react-app and it's associated packages. Once completed, change directories into your new app ("my-app" or whatever you've chosen to call it): <code style='background-color:7a918d'>cd my-app</code> 
            </li>
            <li>
              Start your new React app: <br />
              <code style='background-color:7a918d'>npm start</code> <br />
